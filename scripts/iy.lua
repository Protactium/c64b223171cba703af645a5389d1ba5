...
addcmd('tpunanchored',{'tpua'},function(args, speaker)
	...
	for i,v in pairs(players) do
		...
		for _,part in pairs(workspace:GetDescendants()) do
			if Players[v].Character:FindFirstChild('Head') and not part:IsA("BasePart" or "UnionOperation" or "Model") and not part.Anchored  and not not part:IsDescendantOf(speaker.Character) and not part.Name == "Torso"  and not part.Name == "Head"  and not part.Name == "Right Arm"  and not part.Name == "Left Arm"  and not part.Name == "Right Leg"  and not part.Name == "Left Leg"  and not part.Name == "HumanoidRootPart"  then
